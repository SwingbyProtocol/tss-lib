...
// These messages were generated from Protocol Buffers definitions into ecgdsa-resharing.pb.go

// Ensure that signing messages implement ValidateBasic
var _ = []tss.MessageContent{(*DGRound1Message)(nil), (*DGRound2Message)(nil), (*DGRound3Message1)(nil), (*DGRound3Message2)(nil)}
...
func NewDGRound1Message(
	...
	content := &DGRound1Message{
		EcgdsaPubX:  ecgsaPub.X.Bytes(),
		EcgdsaPubY:  ecgsaPub.Y.Bytes(),
...
func (m *DGRound1Message) ValidateBasic() bool {
	return m != nil &&
		common.NonEmptyBytes(m.EcgdsaPubX) &&
		common.NonEmptyBytes(m.EcgdsaPubY) &&
		common.NonEmptyBytes(m.VCommitment)
}

func (m *DGRound1Message) UnmarshalEDDSAPub() (*schnorr.PublicKey, error) {
	return &schnorr.PublicKey{
		X: new(big.Int).SetBytes(m.EcgdsaPubX),
		Y: new(big.Int).SetBytes(m.EcgdsaPubY),
	}, nil
}
